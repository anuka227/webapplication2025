class BookingCard extends HTMLElement {
    ...
    // ✅ Үнийн формат нэгтгэх helper function
    formatPrice(price) {
        if (!price) return '';
        
        // Хэрэв аль хэдийн "₮" агуулсан бол шууд буцаах
        if (price.toString().includes('₮')) {
            return price;
        }
        
        // Тоог format хийх (1000 -> "1,000")
