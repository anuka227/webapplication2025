class OrderOuter extends HTMLElement {
    ...
    connectedCallback() {
		this.type = this.type = this.getAttribute("type") || "default";
		switch(this.type) {
			case "detailed": 
				this.orderDetailed();
				break;
	...
	orderDetailed() {
		...
		<div class="availableData">
				<div class="leftSalons">
					<h2>Салон</h2>
					<div class="Salon">
						<img src="https://images.unsplash.com/photo-1560066984-138dadb4c035?w=500">
						<div>
							<p>Нэр</p>
							<P>Үнэлгээ</P>
						</div>						
						<p>Хаяг</p>
						<p>Үйлчилгээний төрөл</p>
						<p>Үнэ</p>
						<button>Захиалах</button>
					</div>
				</div>
				<div class="rightArtist">
					<h2>Бие даасан артист</h2>
					<div class="Artist">
						<img src="https://images.unsplash.com/photo-1521590832167-7bcbfaa6381f?w=500">
						<div>
							<p>Нэр</p>
							<P>Үнэлгээ</P>
						</div>
